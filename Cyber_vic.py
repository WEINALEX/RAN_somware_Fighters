...
# mdp_salle101="101"
# mot_de_passe_salle_cyber=input("Entrez le mot de passe de la salle : ")
...
class Cybersecurite:
  ...
  # if self.enigme_cyber_1==True and self.enigme_cyber_2==True and self.enigme_cyber_3==True:

  # #Apparition du splash screen avec l'individu louche
  # #pygame clic sur le bloc Social Engineering
  #   def social_engineering_cyber(self):
